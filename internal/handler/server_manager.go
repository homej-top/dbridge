...
func (h *ServerManagerHandler) CreateRole(c *gin.Context) {
	...
	defer driver.Close()
	if err := driver.CreateRole(req.Name); err != nil {
		c.JSON(http.StatusInternalServerError, model.ErrorResponse(model.CodeDatabaseError, err.Error()))
		return
	}
	c.JSON(http.StatusOK, model.SuccessResponse(nil))
...
func (h *ServerManagerHandler) DropRole(c *gin.Context) {
	...
	defer driver.Close()
	if err := driver.DropRole(roleName); err != nil {
		c.JSON(http.StatusInternalServerError, model.ErrorResponse(model.CodeDatabaseError, err.Error()))
		return
	}
	c.JSON(http.StatusOK, model.SuccessResponse(nil))
...
func (h *ServerManagerHandler) AddRoleMember(c *gin.Context) {
	...
	defer driver.Close()
	if err := driver.AddRoleMember(roleName, req.Member); err != nil {
		c.JSON(http.StatusInternalServerError, model.ErrorResponse(model.CodeDatabaseError, err.Error()))
		return
	}
	c.JSON(http.StatusOK, model.SuccessResponse(nil))
...
func (h *ServerManagerHandler) RemoveRoleMember(c *gin.Context) {
	...
	defer driver.Close()
	if err := driver.RemoveRoleMember(roleName, member); err != nil {
		c.JSON(http.StatusInternalServerError, model.ErrorResponse(model.CodeDatabaseError, err.Error()))
		return
	}
	c.JSON(http.StatusOK, model.SuccessResponse(nil))
...
func (h *ServerManagerHandler) ApplyUserPrivileges(c *gin.Context) {
	...
	if len(req.Changes) > 0 {
		req.Changes[0].DryRun = req.DryRun
	}
...
func (h *ServerManagerHandler) AlterUserPassword(c *gin.Context) {
	...
	defer driver.Close()
	if err := driver.AlterUserPassword(userName, req.Password); err != nil {
		c.JSON(http.StatusInternalServerError, model.ErrorResponse(model.CodeDatabaseError, err.Error()))
		return
	}
	c.JSON(http.StatusOK, model.SuccessResponse(nil))
...
func (h *ServerManagerHandler) AlterUserLock(c *gin.Context) {
	...
	defer driver.Close()
	if err := driver.AlterUserLock(userName, req.Lock); err != nil {
		c.JSON(http.StatusInternalServerError, model.ErrorResponse(model.CodeDatabaseError, err.Error()))
		return
	}
	c.JSON(http.StatusOK, model.SuccessResponse(nil))
...
func (h *ServerManagerHandler) AlterUserRename(c *gin.Context) {
	...
	defer driver.Close()
	if err := driver.AlterUserRename(userName, req.NewName); err != nil {
		c.JSON(http.StatusInternalServerError, model.ErrorResponse(model.CodeDatabaseError, err.Error()))
		return
	}
	c.JSON(http.StatusOK, model.SuccessResponse(nil))
...
func (h *ServerManagerHandler) AlterUserDefaultSchema(c *gin.Context) {
	...
	defer driver.Close()
	if err := driver.AlterUserDefaultSchema(userName, req.Schema); err != nil {
		c.JSON(http.StatusInternalServerError, model.ErrorResponse(model.CodeDatabaseError, err.Error()))
		return
	}
	c.JSON(http.StatusOK, model.SuccessResponse(nil))
...
func (h *ServerManagerHandler) GetRolePrivileges(c *gin.Context) {
	...
	if privs == nil {
		privs = []drivers.PrivilegeEntry{}
	}
	parentRoles, _ := driver.GetParentRoles(roleName)
	if parentRoles == nil {
		parentRoles = []drivers.ParentRoleInfo{}
	}
	membersInfo, _ := driver.GetRoleMembers(roleName)
	if membersInfo == nil {
		membersInfo = []drivers.MemberRoleInfo{}
	}
...
func (h *ServerManagerHandler) AlterRoleAttribute(c *gin.Context) {
	...
	defer driver.Close()
	if err := driver.AlterRoleAttribute(roleName, req.Attribute, req.Value); err != nil {
		c.JSON(http.StatusInternalServerError, model.ErrorResponse(model.CodeDatabaseError, err.Error()))
		return
	}
	c.JSON(http.StatusOK, model.SuccessResponse(nil))
...
func (h *ServerManagerHandler) CreateLogin(c *gin.Context) {
	...
	defer driver.Close()
	if err := driver.CreateLogin(req); err != nil {
		c.JSON(http.StatusInternalServerError, model.ErrorResponse(model.CodeDatabaseError, err.Error()))
		return
	}
	c.JSON(http.StatusOK, model.SuccessResponse(nil))
...
func (h *ServerManagerHandler) AlterLogin(c *gin.Context) {
	...
	defer driver.Close()
	if err := driver.AlterLogin(loginName, req); err != nil {
		c.JSON(http.StatusInternalServerError, model.ErrorResponse(model.CodeDatabaseError, err.Error()))
		return
	}
	c.JSON(http.StatusOK, model.SuccessResponse(nil))
...
func (h *ServerManagerHandler) ListDatabaseUsers(c *gin.Context) {
	...
	if users == nil {
		users = []drivers.MSSQLDatabaseUser{}
	}
	c.JSON(http.StatusOK, model.SuccessResponse(users))
}
...
func (h *ServerManagerHandler) CreateDatabaseUser(c *gin.Context) {
	...
	defer driver.Close()
	if err := driver.CreateDatabaseUser(database, req); err != nil {
		c.JSON(http.StatusInternalServerError, model.ErrorResponse(model.CodeDatabaseError, err.Error()))
		return
	}
	c.JSON(http.StatusOK, model.SuccessResponse(nil))
...
func (h *ServerManagerHandler) DropDatabaseUser(c *gin.Context) {
	...
	defer driver.Close()
	if err := driver.DropDatabaseUser(database, userName); err != nil {
		c.JSON(http.StatusInternalServerError, model.ErrorResponse(model.CodeDatabaseError, err.Error()))
		return
	}
	c.JSON(http.StatusOK, model.SuccessResponse(nil))
...
func (h *ServerManagerHandler) BatchCreateDatabaseUsers(c *gin.Context) {
	...
	loginName := c.Param("name")
	var req struct {
		Mappings []drivers.DBUserMapping `json:"mappings"`
	}
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, model.ErrorResponse(model.CodeParamError, err.Error()))
		return
	...
	defer driver.Close()
	if err := driver.BatchCreateDatabaseUsers(loginName, req.Mappings); err != nil {
		c.JSON(http.StatusInternalServerError, model.ErrorResponse(model.CodeDatabaseError, err.Error()))
		return
	}
	c.JSON(http.StatusOK, model.SuccessResponse(nil))
...
func (h *ServerManagerHandler) FixOrphanedUser(c *gin.Context) {
	...
	defer driver.Close()
	if err := driver.FixOrphanedUser(database, userName, req.LoginName); err != nil {
		c.JSON(http.StatusInternalServerError, model.ErrorResponse(model.CodeDatabaseError, err.Error()))
		return
	}
	c.JSON(http.StatusOK, model.SuccessResponse(nil))
...
func (h *ServerManagerHandler) DisableGuest(c *gin.Context) {
	...
	defer driver.Close()
	if err := driver.DisableGuest(database); err != nil {
		c.JSON(http.StatusInternalServerError, model.ErrorResponse(model.CodeDatabaseError, err.Error()))
		return
	}
	c.JSON(http.StatusOK, model.SuccessResponse(nil))
